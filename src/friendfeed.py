...
class FriendFeed(object):
    def __init__(self, auth_nickname=None, auth_key=None, url="http://friendfeed.com"):
    ...
    def fetch_user_profile(self, nickname, **kwargs):
        return self._fetch("/api/user/"+nickname+"/profile", None)

    def fetch_user_profiles(self, nicknames, **kwargs):
        return self._fetch("/api/profiles", None, nickname = ",".join(nicknames))
